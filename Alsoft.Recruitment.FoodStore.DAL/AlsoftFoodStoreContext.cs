...
namespace Alsoft.Recruitment.FoodStore.DAL
{
    public class AlsoftFoodStoreContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasOne(product => product.UnitType).WithMany(type => type.Products).HasForeignKey(product => product.UnitTypeId);
            ...
            modelBuilder.Entity<Discount>().HasOne(discount => discount.DiscountType).WithMany(type => type.Discounts).HasForeignKey(discount => discount.DiscountTypeId);

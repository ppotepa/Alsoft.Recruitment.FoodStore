...
namespace Alsoft.Recruitment.FoodStore.DAL
{
    public static class InMemoryDatabaseSeeder
    {
        ...
        {
            SeedUnitTypes(modelBuilder);
            SeedDiscountTypes(modelBuilder);
            SeedProducts(modelBuilder);
            SeedProductProperties(modelBuilder);
            SeedDiscounts(modelBuilder);
            SeedDiscountProducts(modelBuilder);
        }

        private static void SeedUnitTypes(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<UnitTypeEnumEntity>().HasData
            (
                new UnitTypeEnumEntity("6c4df377-0c6d-4a36-88d5-0ea46818edb9") { EnumerationId = UnitType.Roll, CreatedOn = DateTime.Now },
                new UnitTypeEnumEntity("c59a689d-89fa-48ca-9e4a-c2d27ece412c") { EnumerationId = UnitType.Tin, CreatedOn = DateTime.Now },
                new UnitTypeEnumEntity("e7e28ccf-4c0c-4299-b854-07c8a4b8420f") { EnumerationId = UnitType.Bottle, CreatedOn = DateTime.Now },
                new UnitTypeEnumEntity("0fd52a86-6972-4f05-9cbf-14c8524f91d9") { EnumerationId = UnitType.Bag, CreatedOn = DateTime.Now },
                new UnitTypeEnumEntity("090b50b4-51cf-4bb9-89a8-4bbb26eb7342") { EnumerationId = UnitType.Loaf, CreatedOn = DateTime.Now }
            );
        }

        private static void SeedDiscountTypes(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<DiscountTypeEnumEntity>().HasData
            (
                new DiscountTypeEnumEntity("0c390e11-691a-4627-9953-d5d1adfb983a") { EnumerationId = DiscountType.SameProduct, CreatedOn = DateTime.Now },
                new DiscountTypeEnumEntity("96b66163-9c3b-4de4-8671-15242cdf6892") { EnumerationId = DiscountType.OtherProduct, CreatedOn = DateTime.Now },
                new DiscountTypeEnumEntity("dc2ee7b8-aa70-4c44-b208-b18574507959") { EnumerationId = DiscountType.AllProducts, CreatedOn = DateTime.Now }
            );
        }
        ...
        private static void SeedDiscounts(ModelBuilder modelBuilder)
        {
        ...
        private static void SeedDiscountProducts(ModelBuilder modelBuilder)
        {
